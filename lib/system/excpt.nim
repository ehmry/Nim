...
when defined(solo5):
  import solo5
  proc writeToStdErr(msg: cstring, length: int) = solo5_console_write(msg, csize_t length)
  proc writeToStdErr(msg: cstring) = solo5_console_write(msg, csize_t c_strlen(msg))

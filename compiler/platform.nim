...
type
  TSystemOS* = enum # Also add OS in initialization section and alias
    ...
    osGenode, osJS, osNimVM, osStandalone, osNintendoSwitch, osFreeRTOS, osPlan9, osAny
...
const
  OS*: array[succ(low(TSystemOS))..high(TSystemOS), TInfoOS] = [
     ...
     (name: "FreeRTOS", parDir: "..", dllFrmt: "lib$1.so", altDirSep: "/",
      ...
      scriptExt: ".sh", curDir: ".", exeExt: "", extSep: ".",
      props: {ospPosix}),
     (name: "Plan9", parDir: "..", dllFrmt: "lib$1.a", altDirSep: "/",
      objExt: ".o", # objExt is platform specific
      newLine: "\x0A", pathSep: ":", dirSep: "/",
      scriptExt: ".sh", curDir: ".", exeExt: "", extSep: ".",
      props: {}),
